...
because: "a fenced ocl block under Invariants must be owned by a ### clause heading"
---
<!-- Violates exactly one rule: an `ocl` fence sits under `## Invariants` before any `###` heading. -->
