...
expect: mapping.clause-owns-two-fences
because: "a clause heading owns exactly one ocl fence"
---
<!-- Violates exactly one rule: the last `###` clause heading owns two `ocl` fences. -->
