...
because: "the Capabilities table header must be exactly ID | Name | Description | Actors"
---
<!-- Violates exactly one rule: `## Capabilities` renames the `Actors` column to `Roles`. -->
