...
expect: mapping.both-property-forms
because: "one artifact carries one Properties form, never both"
---
<!-- Violates exactly one rule: `## Properties` carries the typed table AND a `sysml` fence. -->
