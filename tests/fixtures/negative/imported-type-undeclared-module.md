...
expect: mapping.undeclared-import-module
because: "an ImportedTypeRef must name a module the manifest pins in semantic.imports"
---
<!-- Violates exactly one rule: a data dependency names `agent-ix/not-imported`. -->
...
|---|---|---|---|
| AS-900-DAT-1 | Stakeholder requirements rolled up | agent-ix/not-imported#StR | read |
