...
relationships:
  - target: "ix://agent-ix/orders-platform/StR-001"
    ...
    cardinality: "1:N"
---
<!-- ApplicationSpec authoring skeleton (spec-artifacts-app). Fill every section
     ...
     - "## Properties" is the typed field form, header exactly
       ...
       single ```sysml``` fence under the same heading — see
       application-spec.sysml.md. One artifact carries ONE form.
